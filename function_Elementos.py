# Estudos - function_Elementos.pyex100.py
# Autor: José Menescal Neto
# Data: 16/04/22
# Programa para cálculo de treliça.
"""
...
def ElemPort2D(E, A, I, x1, y1, x2, y2):
    ...
    C, S = (x2 - x1) / l, (y2 - y1) / l
    # print C, S
    MatrizPort2D = (E / l) * (array([[(A * C ** 2) + ((12 * I / l ** 2) * S ** 2), (A - (12 * I / l ** 2)) * C * S,
                                      (-6 * I / l) * S, -((A * C ** 2) + ((12 * I / l ** 2) * S ** 2)),
                                      -((A - (12 * I / l ** 2)) * C * S), -((6 * I / l) * S)],
                                     [(A - (12 * I / l ** 2)) * C * S, ((A * S ** 2) + ((12 * I / l ** 2) * C ** 2)),
                                      (6 * I / l) * C, -((A - (12 * I / l ** 2)) * C * S),
                                      -((A * S ** 2) + ((12 * I / l ** 2) * C ** 2)), (6 * I / l) * C],
                                     [(-6 * I / l) * S, (6 * I / l) * C, 4 * I, (6 * I / l) * S, (-6 * I / l) * C,
                                      2 * I],
                                     [-((A * C ** 2) + ((12 * I / l ** 2) * S ** 2)),
                                      -((A - (12 * I / l ** 2)) * C * S), (6 * I / l) * S,
                                      (A * C ** 2) + ((12 * I / l ** 2) * S ** 2), (A - (12 * I / l ** 2)) * C * S,
                                      (6 * I / l) * S],
                                     [-((A - (12 * I / l ** 2)) * C * S),
                                      -((A * S ** 2) + ((12 * I / l ** 2) * C ** 2)), -((6 * I / l) * C),
                                      ((A - (12 * I / l ** 2)) * C * S), ((A * S ** 2) + ((12 * I / l ** 2) * C ** 2)),
                                      -(6 * I / l) * C],
                                     [-((6 * I / l) * S), (6 * I / l) * C, 2 * I, (6 * I / l) * S, -(6 * I / l) * C,
                                      4 * I]]))
    return MatrizPort2D
